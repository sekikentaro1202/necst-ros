...
class plot(object):
    ...
    def plot(self):
        ...
        while not rospy.is_shutdown():
            ...
            plt.plot(az,el,'yellow', marker='*',markersize=14, markeredgewidth=0.7, markeredgecolor='b' , alpha=0.5)
            plt.plot(c_az,c_el,'blue',marker = '.', markersize=10,alpha=0.5)
            plt.xlim(az-0.01, az+0.01)
            plt.ylim(el-0.01, el+0.01)
            plt.pause(0.01)
